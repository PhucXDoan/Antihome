...
#define vi2(X, Y      ) (vi2 { static_cast<i32>(X), static_cast<i32>(Y)                                           })
#define vi3(X, Y, Z   ) (vi2 { static_cast<i32>(X), static_cast<i32>(Y), static_cast<i32>(Z)                      })
#define vi4(X, Y, Z, W) (vi2 { static_cast<i32>(X), static_cast<i32>(Y), static_cast<i32>(Z), static_cast<i32>(W) })

struct vi2 { i32 x; i32 y;               };
struct vi3 { i32 x; i32 y; i32 z;        };
struct vi4 { i32 x; i32 y; i32 z; i32 w; };
